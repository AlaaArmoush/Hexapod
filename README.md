...
| "Find the bottle" | search_intent → ObjectSearcher, no LLM |
| "Find my phone" / "button" | Mapped to `cell phone` / `bottle` via COCO aliases |
...
Alaa Armoush · Abd Alrahman Atout
Supervised by Dr. Anas Toma — Department of Computer Engineering, An-Najah National University, June 2026
